...
export default function Presentation() {
  return (
    ...
    <Card className="flex-row w-full max-w-7xl rounded-3xl shadow-2xl m-5 transition duration-300 ease-in-out transform hover:scale-105" style={{marginTop : "20px"}}>
        <CardHeader shadow={false} floated={false} className="w-72 h-72 shrink-0 m-1 rounded-r-none">
            <img 
        ...
        <CardBody>
            ...
            <a href="/pdf/CV.pdf" className="inline-block" download="CV_Koloina_Rasolofoson.pdf">
